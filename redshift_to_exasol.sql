...
*/
--/
create or replace script database_migration.REDSHIFT_TO_EXASOL(
CONNECTION_NAME --name of the database connection inside exasol -> e.g. redshift_db
...
execute script database_migration.REDSHIFT_TO_EXASOL(
   'redshift_db' -- name of your database connection
